...
class ModelTurner:
    ...
    def __init__(self, run_id, data_path, mode):
        ...
        self.logger = Logger(self.run_id, 'ModelTurner', mode)
    ...
    def best_params_randomforest(self, train_x, train_y):
        ...
        try:
            ...
            self.logger.info('Start of finding best params for randomforest algorithm...')
            ...
            self.logger.info('End of finding best params for randomforest algorithm...')
